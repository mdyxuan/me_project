...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] ingredientList = {R.string.pancakeIngredients, R.string.maggiIngredients, R.string.cakeIngredients, R.string.pastaIngredients, R.string.pizzaIngredients, R.string.burgerIngredients, R.string.friesIngredients};
